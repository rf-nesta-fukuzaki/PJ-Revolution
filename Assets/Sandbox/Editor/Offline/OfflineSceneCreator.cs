...
///
/// 使い方:
///   Unity メニュー → Peak Plunder → Offline → Create Offline Test Scene
///   または
///   Unity メニュー → Peak Plunder → Offline → Refresh Offline Test Scene
///
/// 生成物:
...
public static class OfflineSceneCreator
{
    ...
    // ── メニューアイテム ──────────────────────────────────────
    [MenuItem(PeakPlunderEditorMenus.Offline.CreateOfflineTestScene)]
    ...
    [MenuItem(PeakPlunderEditorMenus.Offline.RefreshOfflineTestScene)]
