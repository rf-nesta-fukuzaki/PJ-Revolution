...
namespace PeakPlunder.EditorTools
{
    ...
    /// Invoke via: Peak Plunder → Bootstrap → Bootstrap All Assets
    /// </summary>
    public static class PeakPlunderAssetBootstrap
    {
        ...
        [MenuItem(PeakPlunderEditorMenus.Bootstrap.BootstrapAllAssets)]
        ...
        [MenuItem(PeakPlunderEditorMenus.Bootstrap.PopulateSoundLibrary)]
        ...
        [MenuItem(PeakPlunderEditorMenus.Bootstrap.CreateAudioMixer)]
