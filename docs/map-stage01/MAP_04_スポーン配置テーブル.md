...
| ゾーン | 標高 | 高山病 | 凍傷 | 風力 |
|------|-----|-------|-----|-----|
| Zone1 | 5〜66m | なし | なし | なし |
| Zone2 | 66〜121m | なし | なし | 弱（0.1） |
| Zone3 | 121〜141m | 弱（開始） | なし | 弱（0.2） |
| Zone4 | 141〜180m | 中（0.5x） | なし | 中（0.3） |
| Zone5 | 180〜210m | 強（1.0x） | あり | 強（0.6） |
| Zone6 | 210〜220m | 最大（1.5x）| あり | 最大（0.8） |
