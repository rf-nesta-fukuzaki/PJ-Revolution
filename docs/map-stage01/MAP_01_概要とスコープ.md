...
| 最高標高 | 220m | terrainHeight |
| 解像度 | 513 | 2^9 + 1 |
| 山頂座標（目安） | (0, 220, +129) | World座標 |
...
| Zone1 森林帯 | `Zone1_Forest` | Z ≈ -96 | 5〜66m | 木・緩斜面、入門ロープ場面 |
| Zone2 岩場帯 | `Zone2_RockySlope` | Z ≈ -45 | 66〜121m | 岩多め、最初のルート分岐 |
| Zone3 急壁 | `Zone3_CliffWall` | Z ≈ +6 | 121〜141m | 垂直に近い崖、ロープ必須 |
| Zone4 神殿遺跡 | `Zone4_TempleRuins` | Z ≈ +45 | 141〜180m | 遺跡建物、トラップ、高価値遺物 |
| Zone5 氷壁 | `Zone5_IceWall` | Z ≈ +84 | 180〜210m | 氷面・強風、IcePatch多数 |
| Zone6 山頂遺跡 | `Zone6_Summit` | Z ≈ +129 | 210〜220m | ゴールエリア、最高難度遺物 |
