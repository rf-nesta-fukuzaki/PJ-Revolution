...
大量のScene YAML手編集は避け、`Assets/Sandbox/Editor/Stage01/Stage01MapBuilder.cs` のUnity Editor APIでシーンを構築する。
...
| ファイル | 役割 |
|---|---|
| `Assets/Sandbox/Editor/Stage01/Stage01MapBuilder.cs` | Stage01 MAPをUnity Editor APIで一括生成するメインビルダー |
| `Assets/Sandbox/Editor/Stage01/Stage01MapValidator.cs` | 生成後のHierarchy、個数、Manager参照、生成Assetを検証する |
| `Assets/Sandbox/Editor/Stage01/GrappableRockPlacer.cs` | `GrappableRocks` 配下に53個以上のグラップル岩を自動配置する |
